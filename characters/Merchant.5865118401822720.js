...
let mission_buttons = [
    ["M-Compound", HandleCompoundablesMission, null, add_top_button],
    ["M-Upgrade", HandleUpgradeablesMission, null, add_top_button],
    ["M-C-Terranger", CollectItemsMission, "Terranger", add_top_button],
    ["M-Deposit", DepositEverythingMission, null, add_bottom_button],
];

for (let btn of mission_buttons) {
    Logger.log(btn.toString());
    let name = btn[0], 
        missionClass = btn[1], 
        param = btn[2],
        gui_method = btn[3];
